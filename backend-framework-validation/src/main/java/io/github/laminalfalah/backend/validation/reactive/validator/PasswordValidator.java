...
import io.github.laminalfalah.backend.validation.annotation.reactive.PasswordValidation;
...
public class PasswordValidator extends AbstractReactiveConstraintValidator<PasswordValidation, String> {
    ...
    @Override
    public Mono<Boolean> validate(String value, PasswordValidation annotation, ConstraintValidatorContext context) {
        if (value == null) {
