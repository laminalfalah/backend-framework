...
public class FieldMatchesValidatorReactive extends AbstractReactiveConstraintValidator<FieldMatchesReactive, Object> {

    @Override
    public Mono<Boolean> validate(Object value, FieldMatchesReactive annotation, ConstraintValidatorContext context) {
