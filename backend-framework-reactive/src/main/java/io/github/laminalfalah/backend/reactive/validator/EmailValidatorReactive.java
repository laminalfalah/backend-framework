...
import io.github.laminalfalah.backend.reactive.annotation.EmailValidationReactive;
...
public class EmailValidatorReactive extends AbstractReactiveConstraintValidator<EmailValidationReactive, String> {

    private final EmailPatternProperties properties;

    public EmailValidatorReactive(EmailPatternProperties properties) {
        this.properties = properties;
    }

    @Override
    public Mono<Boolean> validate(String value, EmailValidationReactive annotation, ConstraintValidatorContext context) {
