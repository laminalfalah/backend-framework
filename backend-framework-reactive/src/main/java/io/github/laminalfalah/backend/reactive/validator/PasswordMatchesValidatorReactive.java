...
public class PasswordMatchesValidatorReactive extends AbstractReactiveConstraintValidator<PasswordMatchesReactive, Object> {

    @Override
    public Mono<Boolean> validate(Object value, PasswordMatchesReactive annotation, ConstraintValidatorContext context) {
