...
import io.github.laminalfalah.backend.reactive.validator.PasswordMatchesValidatorReactive;
...
@Constraint(validatedBy = {
        PasswordMatchesValidatorReactive.class
})
public @interface PasswordMatchesReactive {
