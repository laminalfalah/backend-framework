...
public class IpAddressValidatorReactive extends AbstractReactiveConstraintValidator<IpAddressReactive, String> {

    @Override
    public Mono<Boolean> validate(String value, IpAddressReactive annotation, ConstraintValidatorContext context) {
